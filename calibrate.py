...
import calibrationInfo

cal = calibrationInfo.Info(61362)

outdir = cal.outdir #this is autogenerated from the run number now

# ToDo change output location
calibration_file = 'test.DetCal'

#set calibrant using a json file instead of in script.
cal.setCalibrant("sapphire")
